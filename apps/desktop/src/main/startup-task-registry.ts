...
export function createStartupTaskRegistry<Name extends string>(
  ...
  // Phases are launched at separate startup gates, so a dependency can have
  // completed in an earlier runPhase call. Keep that fact across calls while
  // retaining the phase-local execution order below.
